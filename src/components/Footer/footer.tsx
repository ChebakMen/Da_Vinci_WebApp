...
import VK_svg from '/src/assets/img/vk-logo.svg';
      ...
      <div className="footer__container">
        <div className="footer__contacts">
          ...
          <div className="footer__mail-and-tel">
            <a className="footer__connection" href="mailto:maksim.chebykin03@gmail.com">
              Email: maksim.chebykin03@gmail.com
            </a>
        ...
        <div className="footer__social">
          ...
          <div className="footer__social-items">
            <a className="footer__social-item" href="https://vk.com/da_vinciiii">
              <img src={VK_svg} alt="" width={'40px'} height={'40px'} />
            </a>
            <a className="footer__social-item" href="https://vk.com/da_vinciiii">
            ...
            <a
              ...
              target="_blank">
              <img src={Gos_svg} alt="" className="" width={'40px'} height={'40px'} />
            </a>
          </div>
        </div>
